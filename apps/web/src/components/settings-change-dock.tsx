...
export function SettingsChangeDock({
	...
	return (
		...
		>
			<div
				className={cn(
					"pointer-events-auto flex w-full max-w-3xl flex-col gap-4 rounded-3xl border border-border/70 bg-background/96 px-4 py-3 shadow-black/10 shadow-lg backdrop-blur sm:flex-row sm:items-center sm:justify-between",
