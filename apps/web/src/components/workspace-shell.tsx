  ...
  return (
    <SidebarProvider>
      <ActiveWorkspaceProvider>
        ...
        <SidebarInset className="flex min-h-svh min-w-0 flex-1 flex-col border">
          <header className="sticky top-0 z-10 rounded-t-2xl border-b bg-background/90 backdrop-blur supports-backdrop-filter:bg-background/80">
          ...
          <div className="mx-auto flex min-h-0 w-full min-w-0 max-w-[1600px] flex-1 flex-col overflow-y-auto overflow-x-hidden px-4 py-5 md:px-6 md:py-6 lg:px-8">
            {children}
          </div>
        </SidebarInset>
      </ActiveWorkspaceProvider>
