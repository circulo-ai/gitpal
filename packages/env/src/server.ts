...
export const env = createEnv({
	server: {
		...
		WORKFLOW_REDIS_IDEMPOTENCY_TTL_MS: z.coerce.number().int().positive().default(60_000),
		WORKFLOW_REDIS_STREAM_MAX_LEN: z.coerce.number().int().positive().default(10_000),
